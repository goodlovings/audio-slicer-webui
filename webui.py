...
#音频切分
def slicerAudio(audio, outdir, sr, db_thresh, min_length, min_interval, hop_size, max_sil_kept):
...
with gr.Blocks() as demo:
    ...
    btnSlicer.click(slicerAudio, inputs=[audio, outdir, sr, db_thresh, min_length, min_interval, hop_size, max_sil_kept])
